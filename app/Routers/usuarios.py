...
@router.post("/", response_model=usuario_schema.UsuarioResponse, status_code=status.HTTP_201_CREATED)
...
@router.get("/", response_model= usuario_schema.UsuarioListResponse, status_code=status.HTTP_200_OK)
